...
if __name__ == "__main__":
    retinaface = FaceRecognition()      # 构建识别示例
    #----------------------------------------------------------------------------------------------------------#
    #   mode用于指定测试的模式：
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "data/input_image/"
    dir_save_path   = "data/output_image/"
    ...
    if mode == "predict":
        ...
        while True:
            ...
            if image is None:
                ...
                cv2.imwrite(dir_save_path+'output.jpg',r_image)
        ...
        img = cv2.imread('{}/obama.jpg'.format(dir_origin_path))
